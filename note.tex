...
\title{An independent set of size 1129 in $C_7^{\bt 6}$}
...
their Table 2. They note that it does not improve the capacity bound. Neither does $1129$.
...
The starting set matters. Local search from a random start reached only $317$ to $323$ within
the times we tried. A free search over abelian subgroups of $\mathbb{Z}_N^6$, quantised into
